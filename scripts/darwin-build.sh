...
build() {
    ...
    export CFLAGS='-flto -D_FORTIFY_SOURCE=3 -ftrivial-auto-var-init=zero -fstack-protector-strong -O2 -fomit-frame-pointer -ffunction-sections -fdata-sections -fno-unwind-tables -fno-asynchronous-unwind-tables -fvisibility=hidden'
